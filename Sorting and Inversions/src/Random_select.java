...
public class Random_select {
	...
	public static int Random_asselect(int[] A,int first,int last,int i) {
		if(first-last==0) {
			return A[first];
		}
		...
		if(i==k) {
			...
			return Random_asselect(A,first,q-1,i);
		}
		else {
			return Random_asselect(A, q+1,last,i-k);
		}
	}
	...
	public static void main(String[] args) {
		...
		int middlelement = Random_asselect(list,0,length1-1,middle);
